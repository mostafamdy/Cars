here you can find 2 algorithms for color detection the first one is color_detection.py here we use kmean algo to get most frequent color you can see note.txt to get more info.
